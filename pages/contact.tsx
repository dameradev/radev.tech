          ...
          <section className="mx-auto max-w-screen-xl md:rounded-md md:border md:shadow-lg">
            <div className="grid grid-cols-4  lg:grid-cols-3">
              <div className="col-span-4 bg-gray-50 px-8 py-10  md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
                ...
                <ul>
                  <li className="mb-6">
                    <a className='flex items-center text-left' href="mailto:radevdevelopment@gmail.com">
                      <svg className="shrink-0 mr-6 text-2xl " xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5l-8-5V6l8 5l8-5v2z" /></svg>
                      <div>
                        <p className="cursor-pointer font-serif  md:text-lg">radevdevelopment@gmail.com</p>
                        <span className="block text-xs uppercase">email</span>
                      </div>
                    </a>
                  </li>
                  <li className="my-6">
                    <a className='flex items-center text-left' href="https://twitter.com/dameradev" target="_blank">
                      ...
                      {/* <p className="cursor-pointer font-serif  md:text-lg" href="#">@dameradev</p> */}

                      <div>
                        <p className="cursor-pointer font-serif  md:text-lg">@dameradev</p>
                        <span className="block text-xs uppercase">twitter</span>
                      </div>
                    </a>
                  </li>
                  <li className="my-6">
                    <a className='flex items-center text-left' href="https://github.com/dameradev" target="_blank">
                  ...
                  <li className="my-6 ">
                    <a className='flex items-center text-left' href="https://www.linkedin.com/in/damjan-radev-628120145/" target="_blank">
              ...
              <div className="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
                ...
                <p className="mt-2 mb-4 font-sans text-sm tracking-normal">Ask your question</p>
                <form onSubmit={(e) => {
                  e.preventDefault()
                  if (name && email && message) {
                    ...
                    removeValues()
                    // updateValueManually("name","")
                    // updateValueManually("email","")
                    // updateValueManually("message","")
                  } else {
                  ...
                  <div className="md:col-gap-4 mb-5 grid md:grid-cols-2 ">
                    <input className="px-4 col-span-1 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-secondary text-black" type="text" placeholder="Name" name="name" value={name} onChange={updateValue} />
                    <input className="px-4 col-span-1 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-secondary text-black" type="email" placeholder="Email" name="email" value={email} onChange={updateValue} />
                  </div>
                  <textarea className="px-4 mb-10 w-full resize-y whitespace-pre-wrap border-b py-3 text-sm outline-none focus:border-b-2 focus:border-secondary text-black" id="" rows={6} placeholder="Message" name="message"  value={message} onChange={updateValue} />
                  <button type="submit" className="group flex cursor-pointer items-center rounded-xl bg-secondary bg-none px-8 py-4 text-center font-semibold leading-tight text-white">
                    Send
