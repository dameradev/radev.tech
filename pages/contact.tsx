              ...
              <div className="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
                ...
                <form action="">
                  <div className="md:col-gap-4 mb-5 grid md:grid-cols-2 ">
                    <input className="px-4 col-span-1 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-secondary text-black" type="text" placeholder="Name" name="name" />
                    <input className="px-4 col-span-1 w-full border-b py-3 text-sm outline-none focus:border-b-2 focus:border-secondary text-black" type="email" placeholder="Email" name="email" />
                  </div>
                  <textarea className="px-4 mb-10 w-full resize-y whitespace-pre-wrap border-b py-3 text-sm outline-none focus:border-b-2 focus:border-secondary text-black" id="" rows={6} placeholder="Message" name="question"></textarea>
